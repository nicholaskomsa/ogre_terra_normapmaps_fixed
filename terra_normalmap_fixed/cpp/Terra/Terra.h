...
namespace Ogre
{
    ...
    class Terra : public MovableObject
    {
        ...
        Ogre::TextureGpu*   m_tangentMapTex;
    ...
    public:
        ...
        */
        ...
        Ogre::TextureGpu* getTangentMapTex(void) const { return m_tangentMapTex; }
        ...
        const Vector2& getRelativeSize() const          { return m_xzRelativeSize; }
        ...
        int getUnitWidth() { return m_width; }
        int getUnitDepth() { return m_height; }
